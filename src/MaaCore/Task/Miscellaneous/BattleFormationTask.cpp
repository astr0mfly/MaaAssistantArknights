...
void asst::BattleFormationTask::report_operators_requirement()
{
    json::value info = basic_info_with_what("RequirementReport");
    auto& details = info["details"];
    details["report"] = Copilot.dump_requires();
